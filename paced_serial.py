"""Paced serial write + gap-calibration plugin for serial-mcp-server.
...
Install: drop this file in .serial_mcp/plugins/ and enable it, e.g.
    claude mcp add serial -e SERIAL_MCP_PLUGINS=all -- serial_mcp
    # or: SERIAL_MCP_PLUGINS=paced_serial
...
META = {
    "description": (
        "Adds paced (character/line spaced) serial writes and gap-calibration "
        "tools for devices that drop characters at full speed."
    ),
}
...
def _read_until_quiet_sync(buffer: SerialBuffer, overall_timeout_s: float, quiet_s: float, max_bytes: int) -> bytes:
...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "encoding": {"type": "string", "description": "Override encoding (defaults to connection encoding)."},
                "append_newline": {
                    "type": ["boolean", "string"],
                    "default": False,
                ...
                "inter_char_gap_ms": {**_GAP_MS_TYPE, "description": "Delay after each character, in milliseconds."},
                "eol_gap_ms": {
                    **_GAP_MS_TYPE,
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "connection_id": {"type": "string"},
                "inter_char_gap_ms": {**_GAP_MS_TYPE, "default": 0, "description": "Candidate inter-character gap to test."},
                "eol_gap_ms": {**_GAP_MS_TYPE, "default": 0, "description": "Candidate end-of-line gap to test."},
                "test_lines": {
                    "type": "array",
                    "items": {"type": "string"},
                ...
                "newline": {"type": "string", "description": "Line terminator (defaults to connection newline)."},
                "read_timeout_ms": {
                    "type": ["integer", "string"],
                    "default": 3000,
    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "test_lines": {"type": "array", "items": {"type": "string"}, "description": "Lines to send each attempt."},
...
async def handle_sweep(state: SerialState, args: dict[str, Any]) -> dict[str, Any]:
    ...
    if pairwise:
        ...
        combos = list(zip(inter_candidates, eol_candidates))
    else:
